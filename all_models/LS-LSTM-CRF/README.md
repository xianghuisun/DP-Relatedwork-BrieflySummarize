...
python train_wc.py 最终的结果是：loss=0.5565 dev_f1: 0.8733 dev_rec: 0.8720 dev_pre: 0.8746 dev_acc: 0.9744 test_f1: 0.8199 test_rec: 0.8266 test_pre: 0.8133 test_acc: 0.9612
而且epoch到136就达到了early stop





python train_wc.py --co_train --high_way --caseless

(loss: 0.3717, epoch: 87, dev F1 = 0.9458, dev acc = 0.9878)

dev_f1: 0.9458 dev_rec: 0.9412 dev_pre: 0.9505 dev_acc: 0.9878 test_f1: 0.9064 test_rec: 0.9065 test_pre: 0.9063 test_acc: 0.9784
