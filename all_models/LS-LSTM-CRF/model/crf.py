...
class CRFLoss_vb(nn.Module):
    ...
    def forward(self, scores, target, mask):
        ...
        for idx, cur_values in seq_iter:
            ...
            partition.masked_scatter_(mask_idx.bool(), cur_partition.masked_select(mask_idx.bool()))  #0 for partition, 1 for cur_partition
...
class CRFDecode_vb():
    ...
    def decode(self, scores, mask):
        ...
        for idx, cur_values in seq_iter:
            ...
            cur_bp.masked_fill_(mask[idx].view(bat_size, 1).expand(bat_size, self.tagset_size).bool(), self.end_tag)
