...
if __name__ == "__main__":
    ...
    parser.add_argument('--emb_file', default='/home/xhsun/Desktop/NER_Parsing/glove.6B.100d.txt', help='path to pre-trained embedding')
    parser.add_argument('--train_file', default='/home/xhsun/Desktop/gitRepositories/Some-NER-models/data/CoNLL03/en_conll03/train.word.bmes', help='path to training file')
    parser.add_argument('--dev_file', default='/home/xhsun/Desktop/gitRepositories/Some-NER-models/data/CoNLL03/en_conll03/dev.word.bmes', help='path to development file')
    parser.add_argument('--test_file', default='/home/xhsun/Desktop/gitRepositories/Some-NER-models/data/CoNLL03/en_conll03/test.word.bmes', help='path to test file')
    ...
    parser.add_argument('--checkpoint', default='/home/xhsun/Desktop/NER_Parsing/train_models/LM-LSTM', help='checkpoint path')
